package firstExercises;// Un programma che all'avvio chieda un numero, poi chiede un altro numero o Q per smettere di inserire (e cosi via finché non viene inserito Q)
