...
public class Start {
    public static void main(String[] args) {
        ...
        library1.addBook("Fattoria degli animali", 100, 10.0, "George Orwell", LocalDate.of(1945, 1 , 8), "Feltrinelli", Category.NARRATIVA);
        library1.addBook("Fantasie", 100, 70.0, "George Orwell", LocalDate.of(1945, 1 , 8), "Feltrinelli", Category.NARRATIVA);
        library1.addBook("1984", 100, 50.0, "George Orwell", LocalDate.of(1948, 1 , 8), "Feltrinelli", Category.NARRATIVA);
        ...
        Category cat = library1.getMostPopularCategory();
