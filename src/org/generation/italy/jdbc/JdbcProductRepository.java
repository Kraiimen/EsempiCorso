...
public class JdbcProductRepository implements ProductRepository{
    ...
    @Override
    public Product create(Product np) throws DataException {
...
//        }
        ...
        int newKey = template.createAndReturnKey(INSERT_PRODUCT, np.getProductName(), np.getSupplierId(), np.getCategoryId(),
                np.getUnitPrice(), np.getDiscountinued(), np.getProductId());
        np.setProductId(newKey);
        return np;
    }
