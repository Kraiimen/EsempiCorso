...
//        }
        ...
        int key = template.createAndReturnKey(INSERT_PRODUCT, newProduct.getProductName(), newProduct.getSupplierId(), newProduct.getCategoryId(), newProduct.getUnitPrice(), newProduct.getDiscountinued() );
