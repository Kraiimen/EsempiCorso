...
public class OurJdbcTemplate {
    ...
    public <T> List<T> query(String sql, RowMapper<T> mapper, Object... params) throws DataException{ // il primo <T> indica che è un metodo generics in una classe non generics, è sintassi
