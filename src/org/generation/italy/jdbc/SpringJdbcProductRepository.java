...
public class SpringJdbcProductRepository implements ProductRepository{
    ...
    public Product create(Product newProduct) {
        ...
        //contenitore dove mettere la chiave autogenerata dalla query
        template.update(con -> {
            ...
            return ps;
        }, keyHolder); //dà il valore alla chiave
    ...
    public Optional<Product> findById(int id) {
        ...
        //Optiona.ofNullable=if return optional of, else optional vuoto
    }
