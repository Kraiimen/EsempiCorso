...
public class ArrayExamples {
    public static void main(String[] args) {
        ...
        // crea un'altro array di 5 elementi che contenga gli stessi valori dell'array
        // numbers ma al contrario
        ...
        // l'espressione numbers.length-1-i quando i vale 0, varrà 4.
        // numbers.length-1-(number.length-1) 4 3 2 1 0
