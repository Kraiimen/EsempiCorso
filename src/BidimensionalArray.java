public class BidimensionalArray{
    public static void main(String[] args) {
        ...
        for(int i = 0; i < matrix2.length; i++){ // Prendiamo la lunghezza delle righe e ci sono 4 array tramite matrix.length
            System.out.print("[");
            for(int z = 0; z < matrix2[i].length; z++){// prendiamo la lunghezza delle colonne tramite matrix[i]
